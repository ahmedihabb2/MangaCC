...
var Badge = React10.forwardRef(function Badge2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime3.jsxs)(Root, {
    ...rootProps,
    children: [children2, (0, import_jsx_runtime2.jsx)(BadgeComponent, {
      ...badgeProps,
...
function createGrid(options = {}) {
  ...
  const Grid2 = React83.forwardRef(function Grid3(inProps, ref) {
    ...
    let result = (0, import_jsx_runtime52.jsx)(GridRoot, {
      ...
      className: clsx_m_default(classes.root, className),
      ...other,
      children: React83.Children.map(children2, (child) => {
...
function joinChildren(children2, separator) {
  const childrenArray = React84.Children.toArray(children2).filter(Boolean);
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React91.useState(false);
...
var TouchRipple = React92.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React92.useState([]);
  const nextKey = React92.useRef(0);
  const rippleCallback = React92.useRef(null);
  React92.useEffect(() => {
  ...
  const ignoringMouseDown = React92.useRef(false);
  const startTimer = React92.useRef(null);
  const startTimerCommit = React92.useRef(null);
  const container = React92.useRef(null);
  React92.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React92.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start2 = React92.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React92.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React92.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
  ...
  return (0, import_jsx_runtime55.jsx)(TouchRippleRoot, {
...
var ButtonBase = React93.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React93.useRef(null);
  ...
  const [mountedState, setMountedState] = React93.useState(false);
  React93.useEffect(() => {
    setMountedState(true);
  }, []);
  ...
  const keydownRef = React93.useRef(false);
  ...
  return (0, import_jsx_runtime57.jsxs)(ButtonBaseRoot, {
    as: ComponentProp,
    className: clsx_m_default(classes.root, className),
    ownerState,
    onBlur: handleBlur2,
    ...
    children: [children2, enableTouchRipple ? (
      ...
      (0, import_jsx_runtime56.jsx)(TouchRipple_default, {
        ref: handleRippleRef,
        center: centerRipple,
        ...TouchRippleProps
      })
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-KHGVSD6V.js.map
